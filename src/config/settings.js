...
;(()=>{
    // SET MATERIAL GROUPS
    const M = SETTINGS.MATERIALS
    SETTINGS.MATERIAL_GROUPS.GASES = M.AIR|M.VAPOR
    SETTINGS.MATERIAL_GROUPS.LIQUIDS = M.WATER|M.INVERTED_WATER|M.CONTAMINANT
    SETTINGS.MATERIAL_GROUPS.REG_TRANSPIERCEABLE = SETTINGS.MATERIAL_GROUPS.LIQUIDS|SETTINGS.MATERIAL_GROUPS.GASES
    SETTINGS.MATERIAL_GROUPS.CONTAMINABLE = M.WATER|M.INVERTED_WATER
    SETTINGS.MATERIAL_GROUPS.MELTABLE = M.SAND|M.GRAVEL
    SETTINGS.MATERIAL_GROUPS.STATIC = M.AIR|M.STONE

    SETTINGS.MATERIAL_GROUPS.WATER_SKIPABLE = M.STONE|M.GRAVEL|M.SAND|M.WATER
    SETTINGS.MATERIAL_GROUPS.INVERTED_WATER_SKIPABLE = M.STONE|M.GRAVEL|M.SAND|M.INVERTED_WATER
    SETTINGS.MATERIAL_GROUPS.CONTAMINANT_SKIPABLE = M.STONE|M.GRAVEL|M.SAND|M.CONTAMINANT
    SETTINGS.MATERIAL_GROUPS.LAVA_SKIPABLE = M.STONE|M.LAVA
    SETTINGS.MATERIAL_GROUPS.VAPOR_SKIPABLE = M.SAND|M.WATER|M.STONE|M.GRAVEL|M.INVERTED_WATER|M.CONTAMINANT|M.LAVA|M.VAPOR

    SETTINGS.MATERIAL_GROUPS.HAS_VISUAL_EFFECTS = M.ELECTRICITY|M.COPPER
