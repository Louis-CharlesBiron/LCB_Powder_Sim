...
if (self["lcbPS"]) {
   self["createPhysicsCoreWorker"] = self["lcbPS"]["createPhysicsCoreWorker"]
}
...
self.onmessage=e=>{
    ...
    if (!type) {
        ...
        createArrays()
        PHYSICS_CORE = createPhysicsCoreWorker(WORKER_DEPENDENCIES.physicsSettings, WORKER_DEPENDENCIES.MATERIALS_SETTINGS, WORKER_DEPENDENCIES.MATERIALS, WORKER_DEPENDENCIES.MATERIAL_GROUPS, WORKER_DEPENDENCIES.MATERIAL_NAMES, WORKER_DEPENDENCIES.SIDE_PRIORITIES, WORKER_DEPENDENCIES.PHYSICS_DATA_ATTRIBUTES)
        startLoop()
    }
}
