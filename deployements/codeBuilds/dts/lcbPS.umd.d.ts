...
declare function getMaterialsBehavior(MATERIAL_GROUPS: any, FLAGS: any, getSideSelectionPriority: any, nextRandom: any): {
    _updateMaterialsBehaviorGlobals: (contaminationChance: any, lavaMeltChance: any, fireExtinguishesVaporCreationChance: any, fireInflammationChance: any) => void;
    applySandBehavior: (i: any, m_B: any, m_R: any, m_L: any, m_BR: any, m_BL: any, transpierceableMain: any, transpierceableSec: any, indexFlags: any, cache: any) => void;
    applyLiquidBehavior: (i: any, m_B: any, m_R: any, m_L: any, transpierceableMain: any, transpierceableSec: any, indexFlags: any, cache: any) => void;
    applyGravelBehavior: (i: any, m_B: any, transpierceableMain: any, indexFlags: any) => void;
    applyInvertedWaterBehavior: (i: any, m_T: any, m_R: any, m_L: any, transpierceableMain: any, transpierceableSec: any, indexFlags: any, cache: any) => void;
    applyContaminantBehavior: (m_B: any, m_R: any, m_L: any, m_T: any, gi_B: any, gi_R: any, gi_L: any, gi_T: any, gridIndexes: any, indexFlags: any) => void;
    applyLavaBehavior: (gi: any, m_B: any, m_R: any, m_L: any, m_T: any, gi_B: any, gi_R: any, gi_L: any, gi_T: any, gridIndexes: any, indexFlags: any) => void;
...
declare class Color {
    ...
    static "__#private@#unlinkRGBA"(rgba: any): any[];
    static "__#private@#rgbaToHsv"(rgba: any): number[];
    static "__#private@#hsvToRgba"(hsv: any): number[];
    static "__#private@#rgbaToHex"(rgba: any): string;
    static "__#private@#hexToRgba"(hex: any): number[];
    /**
...
declare const c_ll: any;
declare class _HasColor {
    /**
...
declare class TypingDevice {
    static "__#private@#LISTENER_ID_GIVER": number;
    static "__#private@#ID_INDEX": number;
    static KEYS: {
        A: string;
        B: string;
        C: string;
    ...
    static "__#private@#MOD_REPEATING": number;
    static "__#private@#REPEATING_DELAYS": any[];
    _keysPressed: any[];
    _listeners: any[];
    /**
...
declare class TextStyles {
    ...
    static "__#private@#FONTFACE_NAME_OFFSET": number;
    /**
...
declare class RenderStyles extends _HasColor {
    [x: number]: string | (() => {});
    static JOIN_TYPES: {
        MITER: string;
        BEVEL: string;
...
declare const CDE_CANVAS_TIMEOUT_FUNCTION: any;
declare class Canvas {
    ...
    static "__#private@#ON_LOAD_CALLBACKS": any[];
    static "__#private@#ON_FIRST_INTERACT_CALLBACKS": any[];
    ...
    static "__#private@#DOM_CANVAS_LINKS": any;
    static "__#private@#DOM_CANVAS_INTERSECTION_OBSERVER": IntersectionObserver;
    /**
    ...
    static "__#private@#onFirstInteraction"(e: any): void;
    /**
...
declare class Anim {
    static "__#private@#ANIM_ID_GIVER": number;
...
declare class _BaseObj extends _HasColor {
...
declare class AudioDisplay extends _BaseObj {
    [x: number]: string | (() => {});
    ...
    static "__#private@#initAudioDataSource"(dataSource: any, loadCallback: any, errorCB: any): void;
    static "__#private@#initMicrophoneDataSource"(settings: boolean, loadCallback: any, errorCB: any): void;
    static "__#private@#initScreenAudioDataSource"(settings: boolean, loadCallback: any, errorCB: any): void;
    /**
...
declare class ImageDisplay extends _BaseObj {
    ...
    static "__#private@#initData"(dataSource: any, loadCallback: any, width?: any, height?: any): void;
    static "__#private@#initVideoDataSource"(dataSource: any, loadCallback: any, errorCB: any): void;
    static "__#private@#initMediaStream"(stream: any, loadCallback: any, errorCB: any): void;
    static "__#private@#initCameraDataSource"(settings: boolean, loadCallback: any, errorCB: any): void;
    static "__#private@#initCaptureDataSource"(settings: boolean, loadCallback: any, errorCB: any): void;
    /**
...
declare class TextDisplay extends _BaseObj {
    [x: number]: string | (() => {});
...
declare class Pattern extends _DynamicColor {
    [x: number]: string | (() => any);
    static "__#private@#ID_GIVER": number;
    static "__#private@#CROPPING_CTX": OffscreenCanvasRenderingContext2D;
    static "__#private@#MATRIX": DOMMatrixReadOnly;
...
declare class _Obj extends _BaseObj {
...
declare class Shape extends _Obj {
    [x: number]: string | (() => {});
...
declare class Gradient extends _DynamicColor {
    [x: number]: string | (() => {});
    static TYPES: {
        LINEAR: string;
        RADIAL: string;
...
declare class FilledShape extends Shape {
    [x: number]: string | (() => number);
    /**
...
declare class Dot extends _Obj {
    [x: number]: string | (() => {});
    /**
...
declare namespace WARNINGS {
    ...
    function OUT_OF_MEMORY_WARN(mapGrid: any): string;
    function ABSTRACT_INTANCIATION(cls: any): string;
}
...
declare namespace DEFAULT_COLOR_SETTINGS {
    ...
    let VAPOR_1: number[];
    export { VAPOR_1 as VAPOR };
    let FIRE_1: number[];
    export { FIRE_1 as FIRE };
}
declare namespace DEFAULT_USER_SETTINGS {
    let maxDynamicMaterialCount: number;
    let backStepSavingCount: number;
    let backStepSaveOnPlacement: boolean;
    let backStepSavingIsExact: boolean;
    let autoSimulationSizing: any;
    let useMiddleClickToResetDragAndZoom: boolean;
    ...
    let showBrush: boolean;
    let showCursor: boolean;
    let visualEffectsEnabled: boolean;
    let smoothDrawingEnabled: boolean;
    let drawingDisabled: boolean;
    let useMouseVelocityForCreation: boolean;
    let mouseVelocityCoefficient: number;
}
declare namespace DEFAULT_WORLD_START_SETTINGS {
    let autoStart: boolean;
    let usesWebWorkers: number;
    let aimedFPS: number;
    let zoom: any;
...
declare namespace DEFAULT_PHYSICS_SETTINGS {
    let $randomTableSize: number;
    let maxLogCount: number;
    let timerName: string;
    let timerEnabled: boolean;
    let showSkips: boolean;
    let enable2ndFallUniformity: boolean;
    let equivalentTranspierceChance: number;
    let collisionFinalizationTime: number;
    let vaporMovementChance: number;
    let lavaMovementChance: number;
    let contaminationChance: number;
    let lavaMeltChance: number;
    let fireInflammationChance: number;
    let firePropagatesVaporCreationChance: number;
    let fireExtinguishesVaporCreationChance: number;
    let vaporDecayThreshold: number;
    let fireDecayThreshold: number;
    let baseFriction: number;
    let frictionCoefficient: number;
}
declare class MaterialSettings {
...
declare class MapGrid {
    ...
    static DEFAULT_MAP_WIDTH: number;
    static DEFAULT_MAP_HEIGHT: number;
    constructor(pixelSize: any, mapWidth: any, mapHeight: any);
    _pixelSize: any;
    _mapWidth: any;
    _mapHeight: any;
    /**
     ...
     */
    getLocalMapPixel(pos: [x, y]): number[];
    /**
    ...
    */
    getAdjacency(i: number, direction: {
        b: number;
        r: number;
        l: number;
        br: number;
        ...
        tr: number;
        tl: number;
    }, distance?: number | null): number;
    /**
     * @returns An array of path2d representing the grid lines
     */
    getDrawableGridLines(): Path2D[];
    /**
...
declare class Simulation {
    ...
    static DEFAULT_USER_SETTINGS: {
        ...
        zoomInIncrement: number;
        zoomOutIncrement: number;
